...
## file merged_data_mean.txt
   ...
   ex: with subject 1 and activity WALKING, the var tBodyAcc-mean()-X contain the mean
   of all the rows in the table merged_data of the subject 1 with the activity WALKING
